...
<div class="menu">
			<ul>
				<li><a href="index.php" style="border:none;" class="active">Home</a></li>
...
<br>
			...
			<?php
			  ...
			  //if($con)
				  $query ="select * from produc1 where status=1";
...
1						   ?>
    					...
    					?>%OFF</span>
							...
							<input type="submit" id="right-button" name="buy" onclick="show()" value="Buy">
							</section>
						   </li>
						   </ul>
						   </form>
